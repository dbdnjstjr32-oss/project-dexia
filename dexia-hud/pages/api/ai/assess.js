...
// The control plane requires the X-Dexia-Key; attach it server-side (the browser
// never holds it), matching /api/command. Without this the assess endpoint 401s
// ('missing or invalid API key') and the AI-staff card silently shows nothing.
